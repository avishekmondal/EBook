...
public class OnboardFragment3 extends Fragment {
    ...
    public static OnboardFragment3 newInstance(String param1, String param2) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        imageView.setImageDrawable(ContextCompat.getDrawable(getContext(), R.drawable.ic_action_onboard_3));
    }
}